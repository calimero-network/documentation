...
- [SDK Guide (Rust)](/builder-directory/sdk-guide/) — the app model: state, logic, CRDTs, events, storage.
- [JavaScript SDK Guide](/builder-directory/js-sdk-guide/) — calling apps from JS/TS with mero.js.
